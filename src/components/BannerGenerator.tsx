  ...
  const generateImage = async () => {
    ...
    try {
      ...
      if (uploadedImage) {
        ...
        // No uploaded image - create a text-only image
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Describe what you want to create, optionally upload an image, and our AI will generate a new image for you.
            </p>
            <div className="mt-4 inline-block bg-yellow-100 text-yellow-800 px-4 py-2 rounded-lg text-sm">
              ⚠️ Demo Version: Currently using basic image processing. Real AI integration coming soon!
            </div>
          </div>
          ...
          <div className="mt-16 bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-800 mb-2">2. Upload (Optional)</h3>
                <p className="text-gray-600">
                  Optionally upload an image to use as a base or reference for your creation.
                </p>
              </div>
